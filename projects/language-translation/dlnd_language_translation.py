...
def text_to_ids(source_text, target_text, source_vocab_to_int, target_vocab_to_int):
    ...
    source_id_text =  [ 
         [source_vocab_to_int[w] 
          for w in sentence.split()] 
             for sentence in source_text.split('\n')
     ]
    target_id_text =  [ 
        [target_vocab_to_int[w] 
         for w in sentence.split()] + [target_vocab_to_int['<EOS>']] 
...
def model_inputs():
    ...
    return inputs, targets, learning_rate, keep_prob, tsl, mtl, ssl
...
#     print(training_decoder_output.get_shape(), inference_decoder_output.get_shape())
